...
with product_ids as (insert into products (title, description, price) values 
	('РЮКЗАК BUTTERFLY YASYO', 'Новый стильный и функциональный рюкзак Butterfly Yasyo с отделом для обуви. Внутри имеется специальный карман для чехла с ракеткой. Имеет плотный и износостойкий иматериал. Объем: 36 л. Размеры: 45х36х22 см. Ткань: полиэстер 1620D', 100),
	('РАКЕТКА BUTTERFLY TIMO BOLL BLACK', 'Самая дорогая и самая мощная ракетка серии Buttefly Timo Boll. Полностью сосредоточена на агрессивную атакующую игру. Толщина губки 2.0 дает взривную скорость, при этом не позволяет много терять в контроле мяча.', 150),
	('КРОССОВКИ BUTTERFLY LEZOLINE TRYNEX', 'Модель вышла на замену легендарным Butterfly Utop. Мягкая и цепка подошла, выполненная из специального материала для зальных видов спорта, обеспечит прекрасный контроль работы ног. Trynex прекрасно вентилирует за счет текстильных вставок сетки в верхней части кроссовка. Стоит отметить защищенный полиуретановый носок и пятка, которые обеспечивают долговечную службу обуви.', 150)
	returning id)
